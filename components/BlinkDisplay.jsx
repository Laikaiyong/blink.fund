...
import img from "../public/solhealthy.png";
...
const BlinkDisplay = ({
  ...
  return (
    <div className="p-4 text-center flex align-middle justify-center">
      {contextHolder}
      <div className="w-2/3 cursor-default overflow-hidden rounded-2xl border border-stroke-secondary bg-dark-background shadow-action">
        ...
        <div className="flex flex-col p-5 text-start text-white">
          ...
          <span className="mb-0.5 text-text font-semibold text-purple-accent">
            {title}
          </span>
          ...
          <div className="mb-4">
            <div className="bg-transparent-warning text-warning-accent border-stroke-warning rounded-lg border p-3 text-subtext">
              <p>
              ...
              <a
                className="mt-3 inline-block font-semibold transition-colors hover:text-warning-accent-hover motion-reduce:transition-none"
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-wrap items-center gap-2">
              {(actions) && actions.map((action, index) => (
                ...
                >
                  <div className="text-white bg-purple-accent rounded-lg flex w-full items-center justify-center text-nowrap rounded-button px-4 py-3 text-text font-semibold transition-colors motion-reduce:transition-none bg-button text-text-button hover:bg-button-hover">
                    <button className="min-w-0 truncate">
                      Send {action.value} USDC
                    </button>
                  </div>
                </div>
              ))}
              ...
              <div>
                <div className="peer relative flex min-h-10 items-center gap-1.5 border border-input-stroke py-1.5 pl-4 pr-1.5 transition-colors motion-reduce:transition-none focus-within:has-[:invalid]:border-input-stroke-error focus-within:has-[:valid]:border-input-stroke-selected focus-within:hover:has-[:invalid]:border-input-stroke-error focus-within:hover:has-[:valid]:border-input-stroke-selected hover:has-[:enabled]:border-input-stroke-hover rounded-input-standalone">
                  <input type="number" placeholder="Enter the amount of USDC Token to send"  className="font-thin flex-1 truncate bg-transparent  text-white outline-none placeholder:text-text-input-placeholder disabled:text-text-input-disabled" />
            ...
            {blinkAccount != undefined && (
              <button
                ...
                className="w-full p-2 bg-purple-accent rounded-full text-white"
              >
